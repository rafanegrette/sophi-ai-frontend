...
export function Reading() {
    ...
    const {data: currentBookState = initialBookState,
            isSuccess: isSuccessFetchingBookState
    } = useFetchBookStateQuery(bookId, {skip});
    ...
    useEffect(() => {
        if (isSuccessFetchingBook && isSuccessFetchingBookState) {
